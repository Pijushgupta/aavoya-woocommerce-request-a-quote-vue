<template>
  <li class="border-b last:border-b-0    mb-0 ">
	  ...
	  <div class="form-row flex flex-row justify-between items-center px-4 py-2">
        ...
        <span class="flex items-center justify-center border text-black rounded-full flex justify-center items-center w-10 h-10 mr-2 " >
          {{localRow.ID}}
        </span>
				<button class="flex items-center justify-center border text-black rounded-full flex justify-center items-center w-10 h-10 mr-2 hover:text-blue-500" v-on:click="deleteForm" >
