<template>
	<div v-if="tags !== null" class="container mx-auto border md:w-7/12 my-10 rounded-lg">
		<ul >
			<Row
			v-for="tag in tags"
	...
	<div v-else  class="container mx-auto md:w-7/12 my-10 flex flex-col items-center">
		<h2 class="inline text-2xl font-semibold text-gray-600  tracking-wide mb-4">Unable to Find Product Tags.</h2>
