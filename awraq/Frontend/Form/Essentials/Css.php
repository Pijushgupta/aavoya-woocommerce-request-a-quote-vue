...
class Css {
	public static function create() {
		$css 	= '<style>';
		$css .= '.file>label:first-child, .email>label:first-child, .textarea>label:first-child, .tel>label:first-child, .radio>label:first-child, .checkbox>label:first-child .phone>label:first-child .content {display:block; margin-top:10px;}';
