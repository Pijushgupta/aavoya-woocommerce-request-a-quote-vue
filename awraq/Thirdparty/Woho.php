...
class Woho {
	...
	public static function enable() {
		...
		add_action('wp_ajax_awarqUpdateProductCat', array(self::$globalScopeName, 'awarqUpdateProductCat'));	
	}
	...
	public static function fullNameWithParent($cats,$parent_id){
		$svg = '<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline fill-cyan-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" /></svg>';
		foreach($cats as $cat){
	...
	public static function awarqUpdateProductCat(){
		if(!Officer::check($_POST)) wp_die();
